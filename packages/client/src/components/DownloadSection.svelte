<script lang="ts">
  //   const browser = useQueryState<"c" | "f" | "e">("browser");
  let browser = $state<"c" | "f" | "e" | null>(null);

  let getClassesForButton = (v: string) => [
    "hover:scale-[.98] active:scale-[.98] group cursor-pointer transition-all p-4 rounded-box border border-base-200 outline-2 flex flex-col gap-2",
    browser === v
      ? "bg-base-content/5 hover:bg-base-content/15 active:bg-base-content/15 scale-[.98] outline-primary"
      : "hover:bg-base-content/5 active:bg-base-content/5 outline-transparent",
  ];
</script>
...
<section class="flex flex-col items-center md:px-20 lg:px-40 px-4 py-10 gap-4">
  ...
  <div class="flex gap-8 items-center mt-4">
    <button onclick={() => (browser = "c")} class={getClassesForButton("c")}>
          ...
          ><defs
            ...
            ><linearGradient
              ...
              /><stop stop-color="#D9DADB" offset="23.57%" /><stop
                stop-color="#D2D4D5"
                offset="43.8%"
              /><stop stop-color="#D0D2D3" offset="100%" /></linearGradient
            ></defs
          ><g
            ><path
    ...
    <button onclick={() => (browser = "e")} class={getClassesForButton("e")}>
          ...
          ><defs
            ...
            ><radialGradient
              ...
              /><stop offset=".2" stop-color="#2fc2df" /><stop
                offset=".3"
                stop-color="#2bc3d2"
              /><stop offset=".7" stop-color="#36c752" /></radialGradient
            ><radialGradient
              id="edge__f"
              cx="376.5"
              cy="568"
    ...
    <button onclick={() => (browser = "f")} class={getClassesForButton("f")}>
  ...
  {#if browser !== null}
    <div class="flex flex-wrap gap-4 mt-6">
      {#if browser === "c"}
        <div class="flex flex-col p-4 rounded-box border border-base-200 gap-2">
          <h2 class="text-3xl">
